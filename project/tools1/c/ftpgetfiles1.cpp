...
void _help()
{
  ...
  printf("Sample: /project/tools1/bin/procctl 30 /project/tools1/bin/ftpgetfiles /log/idc/ftpgetfiles_surfdata.log \"<host>192.168.226.128:21</host><mode>1</mode><username>xi</username><passwowd>1999</password><remotepath>/tmp/idc/surfdata</remotepath><localpath>/idcdata/surfdata</localpath><matchname>SURF_ZH*.XML,SURF_ZH*.CSV</matchname>\" \n\n");
