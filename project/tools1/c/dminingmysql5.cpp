/*
 *  程序名：dminingmysql5.cpp，本程序是数据中心的公共功能模块，用于从mysql数据库源表抽取数据，生成xml文件。
 *  作者：习家宝。
*/
#include "_public.h"
#include "_mysql.h"
