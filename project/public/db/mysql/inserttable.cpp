...
int main(int argc,char *argv[])
{
  ...
  if (conn.connecttodb("192.168.226.128,root,1999,mysql,3306","utf8")!=0)
  {
  ...
  // 准备插入表的SQL语句。
  stmt.prepare("\
    insert into girls(id,name,weight,btime) values(:1+1,:2,:3+45.35,str_to_date(:4,'%%Y-%%m-%%d %%H:%%i:%%s'))");//%%转义为%
